            ...
            const searchForm =
                <form className="form-entry" role="search">
                    ...
                    <div className="form-entry__field">
                        ...
                        <label className="form-entry__field__label screen-reader-only" for="search-example">
                            Search
                        </label>
